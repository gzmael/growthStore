...
from pets c, specifications s where c.public_id = '${pet_id}' and s.description = 'Black'`);

    await connection.query(`
        insert into pets_specifications select c.id ,s.id 
    from pets c, specifications s where c.public_id = '${pet_id}' and s.description = 'Apartment Living'`);

    await connection.query(`
        insert into pets_specifications select c.id ,s.id 
    from pets c, specifications s where c.public_id = '${pet_id}' and s.description = 'Small'`);

    await connection.query(`
        insert into pets_specifications select c.id ,s.id 
    from pets c, specifications s where c.public_id = '${pet_id}' and s.description = 'Low'`);

    await connection.query(`
        insert into pets_specifications select c.id ,s.id 
    from pets c, specifications s where c.public_id = '${pet_id}' and s.description = 'Cold'`);
